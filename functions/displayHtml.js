import { listenerPossibleMoove } from './listenerPossibleMoove.js'
...
console.log(fullBoard)
    ...
    for(let i =0 ; i< 8;i++){
      ...
      for(let j =  0 ; j < 8; j++){
        ...
        if(typeof(fullBoard[i][j]) === 'object'){
          ...
          if(fullBoard[i][j].symbol === "KI" && fullBoard[i][j].color=== "white"){
            neww.style.background= "url(images/white-king.jpg)"
            neww.style.backgroundSize="cover"
            
            
          }else if(fullBoard[i][j].symbol === "KI" && fullBoard[i][j].color=== "black"){
            neww.style.background= "url(images/black-king.jpg)"
            neww.style.backgroundSize="cover"
          }
          else if(fullBoard[i][j].symbol === "KN" && fullBoard[i][j].color=== "white"){
            neww.style.background= "url(images/white-knight.png)"
            neww.style.backgroundSize="cover"
          }
          else if(fullBoard[i][j].symbol === "KN" && fullBoard[i][j].color=== "black"){
            neww.style.background= "url(images/black-knight.png)"
            neww.style.backgroundSize="cover"
          }
          else if(fullBoard[i][j].symbol === "P" && fullBoard[i][j].color=== "white"){
            neww.style.background= "url(images/white-pawn.jpg)"
            neww.style.backgroundSize="cover"
          }
          else if(fullBoard[i][j].symbol === "P" && fullBoard[i][j].color=== "black"){
            neww.style.background= "url(images/black-pawn.jpg)"
            neww.style.backgroundSize="cover"
          }
          else if(fullBoard[i][j].symbol === "R" && fullBoard[i][j].color=== "white"){
            neww.style.background= "url(images/white-rook.png)"
            neww.style.backgroundSize="cover"
          }
          else if(fullBoard[i][j].symbol === "R" && fullBoard[i][j].color=== "black"){
            neww.style.background= "url(images/black-rook.jpg)"
            neww.style.backgroundSize="cover"
          }
          else if(fullBoard[i][j].symbol === "B" && fullBoard[i][j].color=== "white"){
            neww.style.background= "url(images/white-bishop.jpg)"
            neww.style.backgroundSize="cover"
          }
          else if(fullBoard[i][j].symbol === "B" && fullBoard[i][j].color=== "black"){
            neww.style.background= "url(images/black-bishop.jpg)"
            neww.style.backgroundSize="cover"
          }
          else if(fullBoard[i][j].symbol === "Q" && fullBoard[i][j].color=== "white"){
            neww.style.background= "url(images/white-queen.jpg)"
            neww.style.backgroundSize="cover"
          }
          else if(fullBoard[i][j].symbol === "Q" && fullBoard[i][j].color=== "black"){
    ...
    console.log(fullBoard)
    // listenerPossibleMoove(board)
    listenerPossibleMoove(fullBoard)
}